      ...
      <div className="max-w-5xl mx-auto">
        <AnimatePresence mode="wait">
          ...
          {step === 2 && uploadData && (
            ...
            >
              {/* File Info Bar */}
              <div className="flex items-center justify-between p-4 rounded-xl border border-border bg-card/20 backdrop-blur-md">
                <div className="flex items-center space-x-3">
                  <div className="p-2 rounded-lg bg-zinc-200/50 dark:bg-zinc-900 border border-border text-indigo-400">
                    <FileSpreadsheet className="w-5 h-5" />
                  </div>
                  <div>
                    <h3 className="text-xs font-semibold text-zinc-800 dark:text-zinc-200">{uploadData.filename}</h3>
                    <p className="text-[10px] text-zinc-500 dark:text-zinc-400">File loaded successfully • {uploadData.totalRows} rows parsed</p>
                  </div>
                </div>
                <div className="flex space-x-3">
                  <button
                    onClick={handleReset}
                    className="px-4 py-2 rounded-lg border border-border hover:bg-zinc-100 dark:hover:bg-zinc-900 text-xs font-medium text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 hover:dark:text-zinc-200 transition-colors"
                  >
                    Cancel
                  </button>
                  <button
